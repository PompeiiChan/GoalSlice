"""澄清题库与选项映射（Demo/MVP 静态，对齐原型与 mocks/data.ts）。"""
...
GOAL_TYPE_LABEL_TO_CODE: dict[str, str] = {
    "转行 / 求职": "career_switch",
    "技能提升": "skill_up",
    "面试准备": "interview_prep",
    "作品集建设": "portfolio",
...
GOAL_TYPE_CODE_TO_LABEL: dict[str, str] = {v: k for k, v in GOAL_TYPE_LABEL_TO_CODE.items()}

TIME_LABEL_TO_CODE: dict[str, str] = {
    "5 分钟": "5m",
    "15 分钟": "15m",
    "30 分钟": "30m",
    "60 分钟以上": "60m_plus",
...
TIME_CODE_TO_LABEL: dict[str, str] = {v: k for k, v in TIME_LABEL_TO_CODE.items()}
